...
export const ProductVariant = new SimpleSchema({
  ...
  downloadLink: {
    ...
    optional: true,
    defaultValue: "",
    label: "Download Link for digital product"
  },
  digitalProductName: {
    type: String,
    optional: true,
    defaultValue: "",
    label: "File name of digital product"
  },
  digitalProductSize: {
    type: Number,
    optional: true,
    defaultValue: 0,
    label: "The file size for digital products"
  },
  isVisible: {
    type: Boolean,
    index: 1,
...
export const Product = new SimpleSchema({
  ...
  isDigital: {
    type: Boolean,
    label: "Indicates if product is a digital product",
    defaultValue: false,
    optional: true
  },
  vendor: {
